...
export async function GET(request: Request) {
  return NextResponse.json(
    { 
      faq: {
        "What languages can I use?": "You can use any language to create your API",
        ...
        "Can I double dip with SOM": "Yes, you can double dip with the Summer of Making program"
      },
    }
  );
}
